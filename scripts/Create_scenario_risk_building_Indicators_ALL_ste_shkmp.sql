...
CAST(CAST(ROUND(CAST((COALESCE((AVG(a."sL_Str_r2" + a."sL_NStr_r2"))/ NULLIF(AVG((b.structural + b.nonstructural)),0),0)) AS NUMERIC),6) AS FLOAT) AS NUMERIC) AS "sLr_Bldg_r2",
...
LEFT JOIN lut.collapse_probability g ON b.bldgtype = g.eqbldgtype
LEFT JOIN boundaries."Geometry_SAUID" z ON b.sauidid = z."SAUIDt"
GROUP BY b.id_building,b.sauid,c.geom_site,z."PRUID",z."PRNAME",z."ERUID",z."ERNAME",z."CDUID",z."CDNAME",z."CSDUID",z."CSDNAME";
