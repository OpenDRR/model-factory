...
DROP TABLE IF EXISTS psra_bc.psra_bc5920a2_avg_losses_stats_b0, psra_bc.psra_bc5920a2_avg_losses_stats_r2, psra_bc.psra_bc5920a2_avg_losses_stats CASCADE;

-- create table
CREATE TABLE psra_bc.psra_bc5920a2_avg_losses_stats_b0(
...
-- create table
CREATE TABLE psra_bc.psra_bc5920a2_avg_losses_stats_r2(
PRIMARY KEY(asset_id),
asset_id varchar,
"BldEpoch" varchar,
"BldgType" varchar,
...
CREATE TABLE psra_bc.psra_bc5920a2_avg_losses_stats AS
(SELECT
a.asset_id,
a."BldEpoch",
a."BldgType",
...
FROM psra_bc.psra_bc5920a2_avg_losses_stats_b0 a
INNER JOIN psra_bc.psra_bc5920a2_avg_losses_stats_r2 b ON a.asset_id = b.asset_id);

DROP TABLE IF EXISTS psra_bc.psra_bc5920a2_avg_losses_stats_b0, psra_bc.psra_bc5920a2_avg_losses_stats_r2;