...
FROM results_nhsl_physical_exposure.nhsl_physical_exposure_indicators_hexgrid_1km_uc a
...
DROP TABLE IF EXISTS results_psra_national.psra_sri_calc_hg_1km_uc CASCADE;
CREATE TABLE results_psra_national.psra_sri_calc_hg_1km_uc AS
(
SELECT
a."gridid_1",
