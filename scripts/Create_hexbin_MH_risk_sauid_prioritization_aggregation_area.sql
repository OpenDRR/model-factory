...
--5km
DROP VIEW IF EXISTS results_nhsl_hazard_threat.nhsl_hazard_threat_prioritization_hexgrid_5km_area;
CREATE VIEW results_nhsl_hazard_threat.nhsl_hazard_threat_prioritization_hexgrid_5km_area AS 
SELECT
b.gridid_5,
...
-- 10km
DROP VIEW IF EXISTS results_nhsl_hazard_threat.nhsl_hazard_threat_prioritization_hexgrid_10km_area;
CREATE VIEW results_nhsl_hazard_threat.nhsl_hazard_threat_prioritization_hexgrid_10km_area AS 
SELECT
b.gridid_10,
--SUM("E_AreaKm2" * b.area_ratio) AS "Et_AreaKm2",
--SUM("E_AreaHa" * b.area_ratio) AS "Et_AreaHa",
...
-- 25km
DROP VIEW IF EXISTS results_nhsl_hazard_threat.nhsl_hazard_threat_prioritization_hexgrid_25km_area;
CREATE VIEW results_nhsl_hazard_threat.nhsl_hazard_threat_prioritization_hexgrid_25km_area AS 
SELECT
b.gridid_25,
--SUM("E_AreaKm2" * b.area_ratio) AS "Et_AreaKm2",
--SUM("E_AreaHa" * b.area_ratio) AS "Et_AreaHa",
...
-- 50km
DROP VIEW IF EXISTS results_nhsl_hazard_threat.nhsl_hazard_threat_prioritization_hexgrid_50km_area;
CREATE VIEW results_nhsl_hazard_threat.nhsl_hazard_threat_prioritization_hexgrid_50km_area AS 
SELECT
b.gridid_50,
--SUM("E_AreaKm2" * b.area_ratio) AS "Et_AreaKm2",
--SUM("E_AreaHa" * b.area_ratio) AS "Et_AreaHa",
...
-- 100km
DROP VIEW IF EXISTS results_nhsl_hazard_threat.nhsl_hazard_threat_prioritization_hexgrid_100km_area;
CREATE VIEW results_nhsl_hazard_threat.nhsl_hazard_threat_prioritization_hexgrid_100km_area AS 
SELECT
b.gridid_100,
--SUM("E_AreaKm2" * b.area_ratio) AS "Et_AreaKm2",
--SUM("E_AreaHa" * b.area_ratio) AS "Et_AreaHa",
