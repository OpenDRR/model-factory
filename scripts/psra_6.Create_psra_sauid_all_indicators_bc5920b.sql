...
DROP VIEW IF EXISTS results_psra_bc.psra_bc5920b_all_indicators_s CASCADE;
CREATE VIEW results_psra_bc.psra_bc5920b_all_indicators_s AS 
...
RIGHT JOIN psra_bc.psra_bc5920b_cd_dmg_mean c ON a.id = c.asset_id
...
RIGHT JOIN psra_bc.psra_bc5920b_ed_dmg_mean g ON a.id = g.asset_id
