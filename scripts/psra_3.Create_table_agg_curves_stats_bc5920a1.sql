...
DROP TABLE IF EXISTS psra_bc.psra_bc5920a1_agg_curves_stats_b0, psra_bc.psra_bc5920a1_agg_curves_stats_r2, psra_bc.psra_bc5920a1_agg_curves_stats CASCADE;
...
LEFT JOIN psra_bc.psra_bc5920a1_agg_curves_stats_r2 b ON a.return_period = b.return_period AND a.stat = b.stat AND a.loss_type = b.loss_type AND a.fsauid = b.fsauid AND a."GenOcc" = b."GenOcc" AND
a."GenType" = b."GenType" and a.annual_frequency_of_exceedence = b.annual_frequency_of_exceedence);



DROP TABLE IF EXISTS psra_bc.psra_bc5920a1_agg_curves_stats_b0, psra_bc.psra_bc5920a1_agg_curves_stats_r2;