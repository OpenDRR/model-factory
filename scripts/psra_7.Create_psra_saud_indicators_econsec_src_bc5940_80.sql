...
DROP VIEW IF EXISTS results_psra_bc.psra_bc5940_80_economic_security_pml_s CASCADE;
CREATE VIEW results_psra_bc.psra_bc5940_80_economic_security_pml_s AS
...
FROM psra_bc.psra_bc5940_80_agg_curves_stats a;
