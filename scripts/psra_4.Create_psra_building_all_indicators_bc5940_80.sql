...
DROP VIEW IF EXISTS results_psra_bc.psra_bc5940_80_all_indicators_b CASCADE;
CREATE VIEW results_psra_bc.psra_bc5940_80_all_indicators_b AS 
...
RIGHT JOIN psra_bc.psra_bc5940_80_cd_dmg_mean c ON a.id = c.asset_id
...
RIGHT JOIN psra_bc.psra_bc5940_80_ed_dmg_mean g ON a.id = g.asset_id
