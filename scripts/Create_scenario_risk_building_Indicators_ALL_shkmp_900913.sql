...
JOIN boundaries."HexGrid_5km_900913" b ON ST_INTERSECTS(a.geom,ST_TRANSFORM(b.geom,4326))
GROUP BY b.gridid_5;
...
FROM results_dsra_{eqScenario}.dsra_{eqScenario}_shakemap a
JOIN boundaries."HexGrid_10km_900913" b ON ST_INTERSECTS(a.geom,ST_TRANSFORM(b.geom,4326))
...
FROM results_dsra_{eqScenario}.dsra_{eqScenario}_shakemap a
JOIN boundaries."HexGrid_25km_900913" b ON ST_INTERSECTS(a.geom,ST_TRANSFORM(b.geom,4326))
...
FROM boundaries."HexGrid_1km_900913" a
...
FROM results_dsra_{eqScenario}.dsra_{eqScenario}_shakemap a
JOIN boundaries."HexGrid_1km_900913" b ON ST_INTERSECTS(a.geom,ST_TRANSFORM(b.geom,4326))
...
FROM boundaries."HexGrid_5km_unclipped_900913" a
JOIN gmf.shakemap_scenario_extents_temp b ON ST_INTERSECTS(ST_TRANSFORM(a.geom,4326),b.geom)
WHERE b.scenario = '{eqScenario}';
...
FROM results_dsra_{eqScenario}.dsra_{eqScenario}_shakemap a
JOIN boundaries."HexGrid_5km_unclipped_900913" b ON ST_INTERSECTS(a.geom,ST_TRANSFORM(b.geom,4326))
...
FROM results_dsra_{eqScenario}.dsra_{eqScenario}_shakemap a
JOIN boundaries."HexGrid_10km_unclipped_900913" b ON ST_INTERSECTS(a.geom,ST_TRANSFORM(b.geom,4326))
GROUP BY b.gridid_10,b.geom;
...
FROM results_dsra_{eqScenario}.dsra_{eqScenario}_shakemap a
JOIN boundaries."HexGrid_25km_unclipped_900913" b ON ST_INTERSECTS(a.geom,ST_TRANSFORM(b.geom,4326))
GROUP BY b.gridid_25,b.geom;
...
FROM results_dsra_{eqScenario}.dsra_{eqScenario}_shakemap a
JOIN boundaries."HexGrid_50km_unclipped_900913" b ON ST_INTERSECTS(a.geom,ST_TRANSFORM(b.geom,4326))
...
FROM results_dsra_{eqScenario}.dsra_{eqScenario}_shakemap a
JOIN boundaries."HexGrid_100km_unclipped_900913" b ON ST_INTERSECTS(a.geom,ST_TRANSFORM(b.geom,4326))
...
FROM boundaries."HexGrid_1km_unclipped_900913" a
JOIN gmf.shakemap_scenario_extents_temp b ON ST_INTERSECTS(ST_TRANSFORM(a.geom,4326),b.geom)
WHERE b.scenario = '{eqScenario}';
...
FROM results_dsra_{eqScenario}.dsra_{eqScenario}_shakemap a
JOIN boundaries."HexGrid_1km_unclipped_900913" b ON ST_INTERSECTS(a.geom,ST_TRANSFORM(b.geom,4326))
GROUP BY b.gridid_1,b.geom;
...
-- create shakemap in hexgrid for display - 10km
DROP VIEW IF EXISTS results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_10_4326 CASCADE;
CREATE VIEW results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_10_4326 AS
...
-- create shakemap in hexgrid for display - 25km
DROP VIEW IF EXISTS results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_25_4326 CASCADE;
CREATE VIEW results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_25_4326 AS
...
-- create shakemap in hexgrid for display - 1km
DROP TABLE IF EXISTS results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_1_f_4326;
CREATE TABLE results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_1_f_4326 AS
SELECT
a.gridid_1,
a.geom
...
-- calculate avg, min, max pga of shakemap points within 1km hexgrid
DROP TABLE IF EXISTS results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_1_t_4326 CASCADE;
CREATE TABLE results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_1_t_4326 AS
...
-- create dsra scenario shakemap 1km hexgrid and assign PGA value based on nearest shakemap ID
DROP TABLE IF EXISTS results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_1_t1_4326 CASCADE;
CREATE TABLE results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_1_t1_4326 AS
SELECT
a.gridid_1,
0.00 AS "sH_PGA_avg",
0.00 AS "sH_PGA_min",
...
FROM results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_1_f_4326 a
CROSS JOIN LATERAL 
(
SELECT
"sH_PGA",
...
-- update dsra shakeap 1km hexgrid with calculated max PGA values
UPDATE results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_1_t1_4326 b
SET "sH_PGA_max" = a."sH_PGA_max",
"sH_PGA_min" = a."sH_PGA_min",
"sH_PGA_avg" = a."sH_PGA_avg"
FROM results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_1_t_4326 a
WHERE a.gridid_1 = b.gridid_1;

-- remove duplicate gridid_1 values from selection
DROP TABLE IF EXISTS results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_1_tbl_4326 CASCADE;
CREATE TABLE results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_1_tbl_4326 AS
SELECT
DISTINCT(gridid_1),
"sH_PGA_avg",
"sH_PGA_min",
...
FROM results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_1_t1_4326;

-- update assigned 0.00 to null
UPDATE results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_1_tbl_4326
SET "sH_PGA_avg" = NULL WHERE "sH_PGA_avg" = 0.00;
UPDATE results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_1_tbl_4326
SET "sH_PGA_min" = NULL WHERE "sH_PGA_min" = 0.00;

-- drop t
DROP TABLE IF EXISTS results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_1_t_4326,
results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_1_t1_4326,
results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_1_f_4326 CASCADE;

-- create view
DROP VIEW IF EXISTS results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_1_4326;
CREATE VIEW results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_1_4326 AS SELECT * FROM results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_1_tbl_4326;



-- unclipped
-- create shakemap in hexgrid for display - 5km
DROP TABLE IF EXISTS results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_5_uc_f_4326;
CREATE TABLE results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_5_uc_f_4326 AS
SELECT
a.gridid_5,
a.geom
...
-- calculate avg, min, max pga of shakemap points within 5km hexgrid
DROP TABLE IF EXISTS results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_5_uc_t_4326 CASCADE;
CREATE TABLE results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_5_uc_t_4326 AS
...
-- create dsra scenario shakemap 5km hexgrid and assign PGA value based on nearest shakemap ID
DROP TABLE IF EXISTS results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_1_5_uc_t1_4326 CASCADE;
CREATE TABLE results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_5_uc_t1_4326 AS
SELECT
a.gridid_5,
0.00 AS "sH_PGA_avg",
0.00 AS "sH_PGA_min",
...
FROM results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_5_uc_f_4326 a
CROSS JOIN LATERAL 
(
SELECT
"sH_PGA",
...
-- update dsra shakeap 5km hexgrid with calculated max PGA values
UPDATE results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_5_uc_t1_4326 b
SET "sH_PGA_max" = a."sH_PGA_max",
"sH_PGA_min" = a."sH_PGA_min",
"sH_PGA_avg" = a."sH_PGA_avg"
FROM results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_5_uc_t_4326 a
WHERE a.gridid_5 = b.gridid_5;

-- remove duplicate gridid_5 values from selection
DROP TABLE IF EXISTS results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_5_uc_tbl_4326 CASCADE;
CREATE TABLE results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_5_uc_tbl_4326 AS
SELECT
DISTINCT(gridid_5),
"sH_PGA_avg",
"sH_PGA_min",
...
FROM results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_5_uc_t1_4326;

-- update assigned 0.00 to null
UPDATE results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_5_uc_tbl_4326
SET "sH_PGA_avg" = NULL WHERE "sH_PGA_avg" = 0.00;
UPDATE results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_5_uc_tbl_4326
SET "sH_PGA_min" = NULL WHERE "sH_PGA_min" = 0.00;

-- drop t
DROP TABLE IF EXISTS results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_5_uc_t_4326,
results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_5_uc_t1_4326,
results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_5_uc_f_4326 CASCADE;

-- create view
DROP VIEW IF EXISTS results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_5_uc_4326;
CREATE VIEW results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_5_uc_4326 AS SELECT * FROM results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_5_uc_tbl_4326;



-- create shakemap in hexgrid for display - 10km
DROP VIEW IF EXISTS results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_10_uc_4326 CASCADE;
CREATE VIEW results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_10_uc_4326 AS
...
-- create shakemap in hexgrid for display - 25km
DROP VIEW IF EXISTS results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_25_uc_4326 CASCADE;
CREATE VIEW results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_25_uc_4326 AS
...
-- create shakemap in hexgrid for display - 50km
DROP VIEW IF EXISTS results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_50_uc_4326 CASCADE;
CREATE VIEW results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_50_uc_4326 AS
...
-- create shakemap in hexgrid for display - 100km
DROP VIEW IF EXISTS results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_100_uc_4326 CASCADE;
CREATE VIEW results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_100_uc_4326 AS
...
-- create shakemap in hexgrid for display - 1km
DROP TABLE IF EXISTS results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_1_uc_f_4326;
CREATE TABLE results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_1_uc_f_4326 AS
SELECT
a.gridid_1,
a.geom
...
-- calculate avg, min, max pga of shakemap points within 1km hexgrid
DROP TABLE IF EXISTS results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_1_uc_t_4326 CASCADE;
CREATE TABLE results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_1_uc_t_4326 AS
...
-- create dsra scenario shakemap 1km hexgrid and assign PGA value based on nearest shakemap ID
DROP TABLE IF EXISTS results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_1_uc_t1_4326 CASCADE;
CREATE TABLE results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_1_uc_t1_4326 AS
SELECT
a.gridid_1,
0.00 AS "sH_PGA_avg",
0.00 AS "sH_PGA_min",
...
FROM results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_1_uc_f_4326 a
CROSS JOIN LATERAL 
(
SELECT
"sH_PGA",
...
-- update dsra shakeap 1km hexgrid with calculated max PGA values
UPDATE results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_1_uc_t1_4326 b
SET "sH_PGA_max" = a."sH_PGA_max",
"sH_PGA_min" = a."sH_PGA_min",
"sH_PGA_avg" = a."sH_PGA_avg"
FROM results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_1_uc_t_4326 a
WHERE a.gridid_1 = b.gridid_1;

-- remove duplicate gridid_1 values from selection
DROP TABLE IF EXISTS results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_1_uc_tbl_4326 CASCADE;
CREATE TABLE results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_1_uc_tbl_4326 AS
SELECT
DISTINCT(gridid_1),
"sH_PGA_avg",
"sH_PGA_min",
...
FROM results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_1_uc_t1_4326;

-- update assigned 0.00 to null
UPDATE results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_1_uc_tbl_4326
SET "sH_PGA_avg" = NULL WHERE "sH_PGA_avg" = 0.00;
UPDATE results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_1_uc_tbl_4326
SET "sH_PGA_min" = NULL WHERE "sH_PGA_min" = 0.00;

-- drop t
DROP TABLE IF EXISTS results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_1_uc_t_4326,
results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_1_uc_t1_4326,
results_dsra_{eqScenario}.dsra_{eqScenario}_sm_hg_1_uc_f_4326 CASCADE;
