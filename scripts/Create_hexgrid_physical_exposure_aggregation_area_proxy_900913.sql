...
FROM results_nhsl_physical_exposure.nhsl_physical_exposure_indicators_s a
LEFT JOIN boundaries."SAUID_HexGrid_10km_intersect_unclipped_900913" b ON a."Sauid" = b.sauid
LEFT JOIN boundaries."HexGrid_10km_unclipped_900913" c ON b.gridid_10 = c.gridid_10
GROUP BY c.gridid_10,c.geom;
...
FROM results_nhsl_physical_exposure.nhsl_physical_exposure_indicators_s a
LEFT JOIN boundaries."SAUID_HexGrid_25km_intersect_unclipped_900913" b ON a."Sauid" = b.sauid
LEFT JOIN boundaries."HexGrid_25km_unclipped_900913" c ON b.gridid_25 = c.gridid_25
GROUP BY c.gridid_25,c.geom;
