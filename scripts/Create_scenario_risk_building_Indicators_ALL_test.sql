...
CREATE SCHEMA IF NOT EXISTS results_afm7p2_lrdmf;

-- create scenario risk building indicators

DROP VIEW IF EXISTS results_afm7p2_lrdmf.afm7p2_lrdmf_scenario_shakemap_intensity_building CASCADE;
CREATE VIEW results_afm7p2_lrdmf.afm7p2_lrdmf_scenario_shakemap_intensity_building AS 
...
LEFT JOIN gmf.gmfdata_sitemesh_afm7p2_lrdmf_xref e ON b.id = e.id
...
-- create scenario risk building indicators
DROP VIEW IF EXISTS results_afm7p2_lrdmf.afm7p2_lrdmf_damage_state_building CASCADE;
CREATE VIEW results_afm7p2_lrdmf.afm7p2_lrdmf_damage_state_building AS 
...
-- create scenario risk building indicators
DROP VIEW IF EXISTS results_afm7p2_lrdmf.afm7p2_lrdmf_recovery_time_building CASCADE;
CREATE VIEW results_afm7p2_lrdmf.afm7p2_lrdmf_recovery_time_building AS 
...
-- create scenario risk building indicators
DROP VIEW IF EXISTS results_afm7p2_lrdmf.afm7p2_lrdmf_casualties_building CASCADE;
CREATE VIEW results_afm7p2_lrdmf.afm7p2_lrdmf_casualties_building AS 
...
-- 3.3.1 Casualties - b0
Re-- CAST(CAST(ROUND(CAST(a."sL_Fatalities_b0" AS NUMERIC),6) AS FLOAT) AS NUMERIC) AS "sL_Fatality_b0",
...
DROP VIEW IF EXISTS results_afm7p2_lrdmf.afm7p2_lrdmf_social_disruption_building CASCADE;
CREATE VIEW results_afm7p2_lrdmf.afm7p2_lrdmf_social_disruption_building AS 
...
-- create scenario risk building indicators
DROP VIEW IF EXISTS results_afm7p2_lrdmf.afm7p2_lrdmf_economic_loss_building CASCADE;
CREATE VIEW results_afm7p2_lrdmf.afm7p2_lrdmf_economic_loss_building AS 
