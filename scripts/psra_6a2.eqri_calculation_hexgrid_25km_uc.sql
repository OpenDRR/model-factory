...
FROM results_nhsl_physical_exposure.nhsl_physical_exposure_indicators_hexgrid_25km_uc_4326 a
...
DROP TABLE IF EXISTS results_psra_national.psra_sri_calc_hg_25km_uc_4326 CASCADE;
CREATE TABLE results_psra_national.psra_sri_calc_hg_25km_uc_4326 AS
(
SELECT
a."gridid_25",
...
CASE
	WHEN d.eqri_norm_cbrt_minmax_b0 >= 0 AND d.eqri_norm_cbrt_minmax_b0 <= 5.71 THEN 'Very Low Score'
	WHEN d.eqri_norm_cbrt_minmax_b0 > 5.71 AND d.eqri_norm_cbrt_minmax_b0 <= 10.05 THEN 'Relatively Low Score'
...
CASE
	...
	WHEN d.eqri_norm_cbrt_minmax_r1 > 5.78 AND d.eqri_norm_cbrt_minmax_r1 <= 10.54 THEN 'Relatively Low Score'
	WHEN d.eqri_norm_cbrt_minmax_r1 > 10.54 AND d.eqri_norm_cbrt_minmax_r1 <= 20.23 THEN 'Relatively Moderate Score'
	WHEN d.eqri_norm_cbrt_minmax_r1 > 20.23 AND d.eqri_norm_cbrt_minmax_r1 <= 38.93 THEN 'Relatively High Score'
