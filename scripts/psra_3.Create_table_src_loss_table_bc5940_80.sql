...
DROP TABLE IF EXISTS psra_bc.psra_bc5940_80_src_loss_b0, psra_bc.psra_bc5940_80_src_loss_r2, psra_bc.psra_bc5940_80_src_loss CASCADE;
...
INNER JOIN psra_bc.psra_bc5940_80_src_loss_r2 b ON a.source = b.source AND a.loss_type = b.loss_type AND a.trt = b.trt
);

DROP TABLE IF EXISTS psra_bc.psra_bc5940_80_src_loss_b0, psra_bc.psra_bc5940_80_src_loss_r2 CASCADE;