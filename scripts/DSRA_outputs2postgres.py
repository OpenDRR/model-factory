...
python DSRA_outputs2postgres.py --dsraModelDir="https://github.com/OpenDRR/openquake-models/tree/master/deterministic/outputs" --columnsINI="C:\github\OpenDRR\model-factory\scripts\DSRA_Metrics_Columns.ini"
'''
...
def parse_args():
    ...
    parser.add_argument('--columnsINI', type=str, help='PSRA_Metrics_Columns.ini', required=True, default='DSRA_Metrics_Columns.ini')
