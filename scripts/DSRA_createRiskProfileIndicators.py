...
def main ():
    ...
    if args.exposureModel == 'site':
        ...
        sqlquerystring = open('Create_scenario_risk_{aggregation}_Indicators_ALL_shkmp_900913.sql'.format(**{'aggregation':args.aggregation.lower()}), 'r').read().format(**{'eqScenario':args.eqScenario})
