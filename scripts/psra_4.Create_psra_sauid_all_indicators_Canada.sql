...
FULL JOIN psra_canada.psra_canada_agg_curves_q95 c ON a.return_period = c.return_period AND a.loss_type = c.loss_type AND a.ss_region = c.ss_region AND a.annual_frequency_of_exceedence = c.annual_frequency_of_exceedence
