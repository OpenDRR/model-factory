...
FROM results_nhsl_physical_exposure.nhsl_physical_exposure_indicators_hexgrid_10km_uc_4326 a
...
DROP TABLE IF EXISTS results_psra_national.psra_sri_calc_hg_10km_uc_4326 CASCADE;
CREATE TABLE results_psra_national.psra_sri_calc_hg_10km_uc_4326 AS
(
SELECT
a."gridid_10",
