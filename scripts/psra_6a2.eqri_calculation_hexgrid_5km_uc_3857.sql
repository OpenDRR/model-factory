...
CASE
	...
	WHEN d.eqri_norm_cbrt_minmax_b0 > 10.36 AND d.eqri_norm_cbrt_minmax_b0 <= 23.03 THEN 'Relatively High Score'
	WHEN d.eqri_norm_cbrt_minmax_b0 > 23.03 AND d.eqri_norm_cbrt_minmax_b0 <= 100 THEN 'Very High Score'
