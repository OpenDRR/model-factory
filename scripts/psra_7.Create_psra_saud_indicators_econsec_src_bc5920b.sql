...
DROP VIEW IF EXISTS results_psra_bc.psra_bc5920b_economic_security_pml_s CASCADE;
CREATE VIEW results_psra_bc.psra_bc5920b_economic_security_pml_s AS
...
FROM psra_bc.psra_bc5920b_agg_curves_stats a;
