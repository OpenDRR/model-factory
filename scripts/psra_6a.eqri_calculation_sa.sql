...
CASE
	WHEN c.eqri_abs_cbrt_minmax_b0 >= 0 AND c.eqri_abs_cbrt_minmax_b0 <= 3.11 THEN 'Very Low Score'
	WHEN c.eqri_abs_cbrt_minmax_b0 > 3.11 AND c.eqri_abs_cbrt_minmax_b0 <= 8.69 THEN 'Low Score'
	WHEN c.eqri_abs_cbrt_minmax_b0 > 8.69 AND c.eqri_abs_cbrt_minmax_b0 <= 17.61 THEN 'Moderate Score'
...
CASE
	WHEN d.eqri_norm_cbrt_minmax_b0 >= 0 AND d.eqri_norm_cbrt_minmax_b0 <= 2.50 THEN 'Very Low Score'
	WHEN d.eqri_norm_cbrt_minmax_b0 > 2.50 AND d.eqri_norm_cbrt_minmax_b0 <= 6.66 THEN 'Relatively Low Score'
	WHEN d.eqri_norm_cbrt_minmax_b0 > 6.66 AND d.eqri_norm_cbrt_minmax_b0 <= 11.30 THEN 'Relatively Moderate Score'
	WHEN d.eqri_norm_cbrt_minmax_b0 > 11.30 AND d.eqri_norm_cbrt_minmax_b0 <= 19.66 THEN 'Relatively High Score'
	WHEN d.eqri_norm_cbrt_minmax_b0 > 19.66 AND d.eqri_norm_cbrt_minmax_b0 <= 100 THEN 'Very High Score'
...
CASE 
	WHEN c.eqri_abs_cbrt_minmax_r1 >= 0 AND c.eqri_abs_cbrt_minmax_r1 <= 3.11 THEN 'Very Low Score'
	WHEN c.eqri_abs_cbrt_minmax_r1 > 3.11 AND c.eqri_abs_cbrt_minmax_r1 <= 8.69 THEN 'Low Score'
	WHEN c.eqri_abs_cbrt_minmax_r1 > 8.69 AND c.eqri_abs_cbrt_minmax_r1 <= 17.61 THEN 'Moderate Score'
	WHEN c.eqri_abs_cbrt_minmax_r1 > 17.61 AND c.eqri_abs_cbrt_minmax_r1 <= 30.99 THEN 'High Score'
	WHEN c.eqri_abs_cbrt_minmax_r1 > 30.99 AND c.eqri_abs_cbrt_minmax_r1 <= 100 THEN 'Very High Score'
...
CASE
	WHEN d.eqri_norm_cbrt_minmax_r1 >= 0 AND d.eqri_norm_cbrt_minmax_r1 <= 2.50 THEN 'Very Low Score'
	WHEN d.eqri_norm_cbrt_minmax_r1 > 2.50 AND d.eqri_norm_cbrt_minmax_r1 <= 6.66 THEN 'Relatively Low Score'
	WHEN d.eqri_norm_cbrt_minmax_r1 > 6.66 AND d.eqri_norm_cbrt_minmax_r1 <= 11.30 THEN 'Relatively Moderate Score'
	WHEN d.eqri_norm_cbrt_minmax_r1 > 11.30 AND d.eqri_norm_cbrt_minmax_r1 <= 19.66 THEN 'Relatively High Score'
	WHEN d.eqri_norm_cbrt_minmax_r1 > 19.66 AND d.eqri_norm_cbrt_minmax_r1 <= 100 THEN 'Very High Score'
