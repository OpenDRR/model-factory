...
CAST(CAST(ROUND(CAST(AVG(COALESCE(occupants_b0/NULLIF(a.transit,0),10)) AS NUMERIC),6) AS FLOAT) AS NUMERIC) AS "eCtr_Fatality_b0",
...
CAST(CAST(ROUND(CAST(AVG(COALESCE(occupants_r1/NULLIF(a.transit,0),10)) AS NUMERIC),6) AS FLOAT) AS NUMERIC) AS "eCtr_Fatality_r1",
