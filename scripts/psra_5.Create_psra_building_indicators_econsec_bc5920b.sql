...
DROP VIEW IF EXISTS results_psra_bc.psra_bc5920b_economic_security_economic_loss_b CASCADE;
CREATE VIEW results_psra_bc.psra_bc5920b_economic_security_economic_loss_b AS 
