...
CAST(CAST(ROUND(CAST(e."gmv_SA(0.2)" AS NUMERIC),6) AS FLOAT) AS NUMERIC) AS "sH_Sa0p1",
...
CAST(CAST(ROUND(CAST(e."gmv_SA(0.3)" AS NUMERIC),6) AS FLOAT) AS NUMERIC) AS "sH_Sa0p5",
...
LEFT JOIN gmf.gmfdata_sitemesh_{eqScenario}_metrovan_site_xref e ON b.id = e.id
...
-- create scenario risk site indicators
DROP VIEW IF EXISTS results_dsra_{eqScenario}.dsra_{eqScenario}_building_damage_recovery_ste CASCADE;
CREATE VIEW results_dsra_{eqScenario}.dsra_{eqScenario}_building_damage_recovery_ste AS 
...
-- create scenario risk site indicators
DROP VIEW IF EXISTS results_dsra_{eqScenario}.dsra_{eqScenario}_affected_people_casualties_ste CASCADE;
CREATE VIEW results_dsra_{eqScenario}.dsra_{eqScenario}_affected_people_casualties_ste AS 
...
-- create scenario risk site indicators
DROP VIEW IF EXISTS results_dsra_{eqScenario}.dsra_{eqScenario}_affected_people_social_disruption_ste CASCADE;
CREATE VIEW results_dsra_{eqScenario}.dsra_{eqScenario}_affected_people_social_disruption_ste AS 
...
-- create scenario risk site indicators
DROP VIEW IF EXISTS results_dsra_{eqScenario}.dsra_{eqScenario}_economic_security_economic_loss_ste CASCADE;
CREATE VIEW results_dsra_{eqScenario}.dsra_{eqScenario}_economic_security_economic_loss_ste AS 
