...
DROP VIEW IF EXISTS results_psra_bc.psra_bc5920a2_economic_security_economic_loss_s CASCADE;
CREATE VIEW results_psra_bc.psra_bc5920a2_economic_security_economic_loss_s AS 
...
-- src loss values
DROP VIEW IF EXISTS results_psra_bc.psra_bc5920a2_src_loss CASCADE;
CREATE VIEW results_psra_bc.psra_bc5920a2_src_loss AS

SELECT 
source AS "src_zone",
trt AS "src_type",
SUM(loss_value_b0)/(SELECT SUM(loss_value_b0) FROM psra_bc.psra_bc5920a2_src_loss ) AS "src_value_b0",
SUM(loss_value_r2)/(SELECT SUM(loss_value_r2) FROM psra_bc.psra_bc5920a2_src_loss ) AS "src_value_r2"
FROM psra_bc.psra_bc5920a2_src_loss
GROUP BY source,trt;
...
a.trt AS "src_type",
SUM(a.loss_value)/(SELECT SUM(loss_value) FROM psra_bc.psra_bc5920a2_src_loss_b0 ) AS "src_value_b0",
SUM(b.loss_value)/(SELECT SUM(loss_value) FROM psra_bc.psra_bc5920a2_src_loss_b0 ) AS "src_value_r2"
FROM psra_bc.psra_bc5920a2_src_loss_b0 a
INNER JOIN psra_bc.psra_bc5920a2_src_loss_b0 b ON a.source = b.source AND a.trt = b.trt
GROUP BY a.source,a.trt;

SELECT
SUM(loss_value) AS "TLossValue"
FROM psra_bc.psra_bc5920a2_src_loss_b0
GROUP BY source;

-- source - b0,r2
DROP VIEW IF EXISTS results_psra_bc.psra_bc5920a2_src_stats_source_b0, results_psra_bc.psra_bc5920a2_src_stats_source_R2 CASCADE;

CREATE VIEW results_psra_bc.psra_bc5920a2_src_stats_source_b0 AS
(
SELECT 
'bc5920a2' AS "region",
source,
SUM(loss_value) AS "total_loss_source",
SUM(loss_value)/(SELECT SUM(loss_value) FROM psra_bc.psra_bc5920a2_src_loss_b0 )*100 AS "total_srce_p"
FROM psra_bc.psra_bc5920a2_src_loss_b0
GROUP BY source
);

CREATE VIEW results_psra_bc.psra_bc5920a2_src_stats_source_r2 AS
(
SELECT 
'bc5920a2' AS "region",
source,
SUM(loss_value) AS "total_loss_source",
SUM(loss_value)/(SELECT SUM(loss_value) FROM psra_bc.psra_bc5920a2_src_loss_b0 )*100 AS "total_srce_p"
FROM psra_bc.psra_bc5920a2_src_loss_r2
GROUP BY source
);


-- loss type - b0,r2
DROP VIEW IF EXISTS results_psra_bc.psra_bc5920a2_src_stats_loss_type_b0, results_psra_bc.psra_bc5920a2_src_stats_loss_type_r2 CASCADE;

CREATE VIEW results_psra_bc.psra_bc5920a2_src_stats_loss_type_b0 AS
(
SELECT
'bc5920a2_b0' AS "region",
loss_type,
SUM(loss_value) AS "total_lt",
SUM(loss_value)/(SELECT SUM(loss_value) FROM psra_bc.psra_bc5920a2_src_loss_b0 )*100 AS "total_lt_p"
FROM psra_bc.psra_bc5920a2_src_loss_b0
GROUP BY loss_type
);

CREATE VIEW results_psra_bc.psra_bc5920a2_src_stats_loss_type_r2 AS
(
SELECT
'bc5920a2_r2' AS "region",
loss_type,
SUM(loss_value) AS "total_lt",
SUM(loss_value)/(SELECT SUM(loss_value) FROM psra_bc.psra_bc5920a2_src_loss_b0 )*100 AS "total_lt_p"
FROM psra_bc.psra_bc5920a2_src_loss_r2
...
DROP VIEW IF EXISTS results_psra_bc.psra_bc5920a2_src_stats_source_losstype_b0, results_psra_bc.psra_bc5920a2_src_stats_source_losstype_r2 CASCADE;

CREATE VIEW results_psra_bc.psra_bc5920a2_src_stats_source_losstype_b0 AS
(
SELECT 
'bc5920a2' AS "region",
source,
...
SUM(loss_value)/(SELECT SUM(loss_value) FROM psra_bc.psra_bc5920a2_src_loss_b0 )*100 AS "total_srce_lt_p"
FROM psra_bc.psra_bc5920a2_src_loss_b0
GROUP BY source,loss_type
);

CREATE VIEW results_psra_bc.psra_bc5920a2_src_stats_source_losstype_r2 AS
(
SELECT 
'bc5920a2' AS "region",
source,
...
DROP VIEW IF EXISTS results_psra_bc.psra_bc5920a2_src_stats_source_losstype_trt_b0, results_psra_bc.psra_bc5920a2_src_stats_source_losstype_trt_r2 CASCADE;

CREATE VIEW results_psra_bc.psra_bc5920a2_src_stats_source_losstype_trt_b0 AS
(
SELECT 
'bc5920a2' AS "region",
source,
...
SUM(loss_value)/(SELECT SUM(loss_value) FROM psra_bc.psra_bc5920a2_src_loss_b0 )*100 AS "total_srce_lt_trt_p"
FROM psra_bc.psra_bc5920a2_src_loss_b0
GROUP BY source,loss_type,trt
);

CREATE VIEW results_psra_bc.psra_bc5920a2_src_stats_source_losstype_trt_r2  AS
(
SELECT 
'bc5920a2' AS "region",
source,
