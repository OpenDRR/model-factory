...
DROP VIEW IF EXISTS results_dsra_{eqScenario}.dsra_{eqScenario}_indicators_ste CASCADE;
CREATE VIEW results_dsra_{eqScenario}.dsra_{eqScenario}_indicators_ste AS 
